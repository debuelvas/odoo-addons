        ...
        for documento in self:
            ...
            if documento.model_id=="hr.payslip.electronic":
                ...
                documento.write({
                    ...
                    "estado":"procesado_con_errores_campos" if status_message[0].text in ("Documento con errores en campos mandatorios.") else "track_id" if status_description[0].text in("Batch en proceso de validación.","En proceso de validación") or "Set de prueba con identificador" in status_description[0].text else ("procesado_con_errores_campos" if status_description[0].text in("Documento con errores en campos mandatorios.") else "procesado_correctamente")
                })
            else:
                pass
