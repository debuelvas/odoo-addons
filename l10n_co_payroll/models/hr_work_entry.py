...
class HrWorkEntry(models.Model):
    ...
    def calcular_valor(self,tipo,horario,partes_dia,festivos,mapa_tipos_horas_extras,time_zone):
        for work_entry in self:
            ...
            #Se le debe quitar unm segundo a la hora final para que el numero de segundos sea correcto.
            #La hora va desde el segundo 0 hasta el segundo 3599.  Cada segundo tiene un indice o un nombre. Dan 3600 segundos por hora.
            #El dia va desde el segundo 0 hasta el segundo 83399.  Dan 83400 segundos el día.
            date_stop_tz = work_entry.date_stop.astimezone(time_zone)-timedelta(seconds=1)
